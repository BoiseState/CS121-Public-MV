 ...
 * 
 * Notice that there is no main() in this class. Critter isn't a
 * driver class. Critter is a kind of thing used within the program.
 *  
 * @author mvail
 */
public class Critter {
	 ...
	 * variables should be left un-initialized by the end of the
	 ...
	 * 
	 * Public getters allow someone outside the Critter
	 * to ask about its instance variable value without
