...
For examples that use local files as inputs/output, such as in Module 5,
you may need to compile and run code from the console or open only the
individual module directory so paths will not be an issue.
