...
public class TempConverter
{
	...
	public static void main(String[] args)
	{
		...
		// Notice the types of each variable: BASE is an int.
		// CONVERSION_FACTOR is a double. celsiusTemp is an int.
		// fahrenheitTemp is a double. BASE is promoted to
		// a double during the evaluation of the expression. 
