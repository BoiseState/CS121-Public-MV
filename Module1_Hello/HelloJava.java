 ...
 * this file is "HelloJava.java". A class must be defined in a .java file with 
 * exactly the same name.
 * 
 * A class usually represents a kind of "thing" that is part of the program.
 * One class in each program, called the driver class, actually represents the 
 * program, itself. HelloWorld is such a class. Other classes in a program
 * represent things that the program needs.
 * 
