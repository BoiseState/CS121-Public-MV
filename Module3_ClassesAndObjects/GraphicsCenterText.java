...
public class GraphicsCenterText extends JPanel
{
	/**
	...
	public void paintComponent(Graphics canvas)
	{
		...
		// Get Font's metrics to allows us to figure out its size
	...
	public static void main(String[] args)
	{
		...
		frame.getContentPane().add(new GraphicsCenterText());
		frame.pack();
