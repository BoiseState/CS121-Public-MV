...
/**
 * Draws a scalable pie chart that is centered and changes
 * size based on the window size.
 * @author amit, mvail
 */
@SuppressWarnings("serial")
public class GraphicsPieChart extends JPanel
{
	...
	public static void main(String[] args)
	{
		...
		frame.getContentPane().add(new GraphicsPieChart());
		frame.pack();
