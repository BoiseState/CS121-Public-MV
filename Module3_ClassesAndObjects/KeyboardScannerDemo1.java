 ...
 * @author mvail
 */
public class KeyboardScannerDemo1 {
	...
	public static void main(String[] args) {
		...
		input = kbd.nextLine(); //reading a whole line from the keyboard
		Scanner lineScan = new Scanner(input); //second Scanner to break up the line
		String name = lineScan.next(); //gets the next token as a String
		double pi = lineScan.nextDouble(); //gets the next token as a double
		//or
		//get the next token as a String and reinterpret it as a double
