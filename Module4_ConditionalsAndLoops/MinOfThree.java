...
public class MinOfThree 
{
	...
	public static void main(String[] args) 
	{
		...
		//THIS IS CONFUSING AND ASKING FOR BUGS - ALWAYS USE { }
		// if (num1 < num2)
		// 	if (num1 < num3)
		// 		min = num1;
		// 	else
		...
		System.out.println("Technique 1 - Minimum value: " + min);		// System.out.println("Technique 1 - Minimum value: " + min);

		// OPTION 2 (which has a sneaky bug - 
		...
		// OPTION 3 (using conditional operator)
		min = Integer.MAX_VALUE;
